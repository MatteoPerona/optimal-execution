...
- **With more data,** we would explore multi-day stability (do the same thresholds work across weeks?), cross-asset transfer (do penny thresholds from INTC work on other penny stocks?), and whether combining OI with a second orthogonal signal (e.g., trade flow or realized volatility) adds genuine edge.
